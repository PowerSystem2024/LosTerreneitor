<script setup>
const title = 'Los Terreneitor';
const descripcion = 'Grupo de estudio de la Tecnicatura Universitaria en Programación - UTN';
const residencia = 'San Rafael, Mendoza, Argentina';
const presentacion = 'Bienvenidos a nuestro portafolio de proyectos. Somos un grupo de estudiantes aplicando y demostrando nuestros conocimientos en el desarrollo web.';
const redesSociales = [
...
const telefono = '+54 9 2604-123456';
</script>
